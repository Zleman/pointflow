var be=Object.defineProperty;var ge=(t,r,i)=>r in t?be(t,r,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[r]=i;var ae=(t,r,i)=>ge(t,typeof r!="symbol"?r+"":r,i);import{r as n,a as M,j as we}from"./copc-DT-tHoXF.js";import{S as Le}from"./index-CF3Ia-Bl.js";const ke=`
'use strict';
...
`;function ze(){const t=new Blob([ke],{type:"application/javascript"}),r=URL.createObjectURL(t),i=new Worker(r);return URL.revokeObjectURL(r),i}class le extends Error{constructor(i,f,S){super(f);ae(this,"code");ae(this,"causeValue");this.name="PointFlowError",this.code=i,this.causeValue=S}}function T(t,r,i){return i instanceof le?i:new le(t,r,i)}function Pe(t){const r=t.toLowerCase();if(r.endsWith(".copc.laz")||r.includes(".copc."))return"#.copc.laz";const i=r.split(".").pop()??"";return i==="las"||i==="laz"?`#.${i}`:""}function Ie(t){if(typeof t=="string")return{url:t,sourceKind:"url",revoke:()=>{}};if(typeof URL=="function"&&t instanceof URL)return{url:t.toString(),sourceKind:"url",revoke:()=>{}};if(typeof Request=="function"&&t instanceof Request)return{url:t.url,sourceKind:"request",revoke:()=>{}};if(!(t instanceof Blob))throw T("PF_INVALID_SOURCE","Unsupported point cloud source type.");if(typeof URL>"u"||typeof URL.createObjectURL!="function")throw T("PF_INVALID_SOURCE","Blob/File sources require URL.createObjectURL support.");const r=URL.createObjectURL(t);return t instanceof File?{url:r+Pe(t.name),sourceKind:"file",revoke:()=>URL.revokeObjectURL(r)}:{url:r,sourceKind:"blob",revoke:()=>URL.revokeObjectURL(r)}}function Re(t,r={}){var B,O,H;const[i,f]=n.useState("idle"),[S,w]=n.useState(0),[C,A]=n.useState(null),[J,m]=n.useState(null),Y=n.useRef(null),h=n.useRef([]),L=n.useRef(0),k=n.useRef(null),z=n.useRef(null),v=n.useRef("url"),y=n.useRef(r.onProgress),c=n.useRef(r.onError),F=n.useRef(r.onAvailableAttributes),s=n.useRef(r.onTelemetry);y.current=r.onProgress,c.current=r.onError,F.current=r.onAvailableAttributes,s.current=r.onTelemetry;const b=(O=(B=r.config)==null?void 0:B.hooks)==null?void 0:O.usePointCloud,g=(H=r.config)==null?void 0:H.pointCloud,$=M(1e4,r.chunkSize,g==null?void 0:g.chunkSize,b==null?void 0:b.chunkSize),Q=r.loaderFactory??(g==null?void 0:g.loaderFactory)??(b==null?void 0:b.loaderFactory)??ze;n.useEffect(()=>{var e,a,x;if(!t){f("idle"),w(0),A(null),m(null);return}f("loading"),w(0),A(null),m(null),h.current=[];const l=++L.current;let p;try{p=Ie(t),v.current=p.sourceKind,z.current=p.revoke}catch(d){const u=T("PF_INVALID_SOURCE","Invalid point cloud source.",d);f("error"),m(u),(e=c.current)==null||e.call(c,u),(a=s.current)==null||a.call(s,{phase:"error",sourceKind:"url",message:u.message});return}(x=s.current)==null||x.call(s,{phase:"start",sourceKind:p.sourceKind,progress:0});const o=Q();return k.current=o,o.onmessage=d=>{var P,I,D,X,Z,N,_,V;if(L.current!==l)return;const u=d.data;switch(u.type){case"HEADER":{u.vertexCount>0&&A(u.vertexCount),(P=F.current)==null||P.call(F,u.attributeKeys),(I=s.current)==null||I.call(s,{phase:"header",sourceKind:v.current,progress:0});break}case"CHUNK":{const{xyz:R,attributes:G,count:j,progress:U}=u,E=Y.current;if(E){if(h.current.length>0){for(const K of h.current)E.pushBinary(K.xyz,K.attributes,K.count);h.current=[]}E.pushBinary(R,G,j)}else h.current.push({xyz:R,attributes:G,count:j});w(U),(D=y.current)==null||D.call(y,U),(X=s.current)==null||X.call(s,{phase:"chunk",sourceKind:v.current,progress:U,chunkCount:j});break}case"DONE":{f("ready"),w(1),(Z=y.current)==null||Z.call(y,1),(N=s.current)==null||N.call(s,{phase:"done",sourceKind:v.current,progress:1});break}case"ERROR":{const R=T("PF_PARSE_FAILED",u.message);f("error"),m(R),(_=c.current)==null||_.call(c,R),(V=s.current)==null||V.call(s,{phase:"error",sourceKind:v.current,message:u.message});break}}},o.onerror=d=>{var P,I;if(L.current!==l)return;const u=T("PF_WORKER_INIT_FAILED",d.message??"Loader worker error");f("error"),m(u),(P=c.current)==null||P.call(c,u),(I=s.current)==null||I.call(s,{phase:"error",sourceKind:v.current,message:u.message})},o.postMessage({type:"PARSE",url:p.url,chunkSize:$}),()=>{L.current++,o.terminate(),k.current=null;const d=z.current;z.current=null,d&&d(),h.current=[]}},[t]);const ee=n.useCallback(l=>{Y.current=l},[]),re=n.useCallback(()=>{var p;L.current++,k.current&&(k.current.terminate(),k.current=null);const l=z.current;z.current=null,l&&l(),h.current=[],f("idle"),w(0),A(null),m(null),(p=s.current)==null||p.call(s,{phase:"abort",sourceKind:v.current,message:"Load aborted by caller."})},[]);return{status:i,progress:S,detectedPointCount:C,error:J,onSceneReady:ee,abort:re}}function de(t,r){return t!==void 0?t:r!==null&&r>0?r:1e6}function Ae(t,r){return t!==void 0?t:r>5e5}function Ue(t){var ce;const{src:r,maxPoints:i,rendererBackend:f,colorBy:S,frustumCulling:w,autoLod:C,lodLevel:A,visualRefreshRateHz:J,adaptiveRefresh:m,adaptiveIngest:Y,chunkSize:h,loaderFactory:L,tier:k,runtimeMode:z,onReady:v,onProgress:y,onError:c,onRenderMetrics:F,renderMetricsRef:s,onRendererResolved:b,onPointPick:g,pickRadius:$,fovStrength:Q,accumulationMode:ee,accumulationThresholdMs:re,onAccumulationChange:B,onAvailableAttributes:O,onLoadTelemetry:H,onLoadControls:l,pickStrategy:p,config:o}=t,e=o==null?void 0:o.pointCloud,a=o==null?void 0:o.global,x=(ce=o==null?void 0:o.hooks)==null?void 0:ce.usePointCloud,d=i??(e==null?void 0:e.maxPoints),u=M("auto",f,e==null?void 0:e.rendererBackend,a==null?void 0:a.rendererBackend),P=S??(e==null?void 0:e.colorBy)??(a==null?void 0:a.colorBy),I=M(!0,w,e==null?void 0:e.frustumCulling,a==null?void 0:a.frustumCulling),D=C??(e==null?void 0:e.autoLod),X=A??(e==null?void 0:e.lodLevel),Z=J??(e==null?void 0:e.visualRefreshRateHz),N=M(!1,m,e==null?void 0:e.adaptiveRefresh,a==null?void 0:a.adaptiveRefresh),_=M(!1,Y,e==null?void 0:e.adaptiveIngest,a==null?void 0:a.adaptiveIngest),V=h??(e==null?void 0:e.chunkSize)??(x==null?void 0:x.chunkSize),R=L??(e==null?void 0:e.loaderFactory)??(x==null?void 0:x.loaderFactory),G=k??(e==null?void 0:e.tier)??(a==null?void 0:a.tier),j=z??(e==null?void 0:e.runtimeMode)??(a==null?void 0:a.runtimeMode),U=$??(e==null?void 0:e.pickRadius)??(a==null?void 0:a.pickRadius),E=p??(e==null?void 0:e.pickStrategy)??(a==null?void 0:a.pickStrategy),K=Q??(e==null?void 0:e.fovStrength),fe=ee??(e==null?void 0:e.accumulationMode),ve=re??(e==null?void 0:e.accumulationThresholdMs),{status:se,progress:pe,detectedPointCount:ne,onSceneReady:ie,abort:oe}=Re(r,{chunkSize:V,loaderFactory:R,onProgress:y,onError:c,onAvailableAttributes:O,onTelemetry:H,config:o});n.useEffect(()=>{l==null||l({abort:oe})},[l,oe]);const W=n.useRef(v);W.current=v,n.useEffect(()=>{var q;se==="ready"&&((q=W.current)==null||q.call(W))},[se]);const[te,he]=n.useState(de(d,null));n.useEffect(()=>{const q=de(d,ne);he(me=>Math.max(me,q))},[d,ne]);const ye=n.useCallback(ie,[ie]),ue=Ae(D,te),xe=ue?3:1;return we.jsx(Le,{maxPoints:te,lodLevels:xe,rendererBackend:u,colorBy:P,frustumCulling:I,autoLod:ue,lodLevel:X,visualRefreshRateHz:Z,adaptiveRefresh:N,adaptiveIngest:_,tier:G,runtimeMode:j,workerMode:!0,onReady:ye,onRenderMetrics:F,renderMetricsRef:s,onRendererResolved:b,onPointPick:g,pickRadius:U,pickStrategy:E,fovStrength:K,accumulationMode:fe,accumulationThresholdMs:ve,onAccumulationChange:B,progress:pe,config:o},te)}export{Ue as PointCloud};
